...
describe('solution', () => {
  ...
  it('should return 0 for number = 3', () => {
    expect(solution.solution(3)).toBe(0);
  });
  it('should return 3 for number = 4', () => {
    expect(solution.solution(4)).toBe(3);
  });
  it('should return 3 for number = 5', () => {
    expect(solution.solution(5)).toBe(3);
  });
  it('should return 8 for number = 6', () => {
    expect(solution.solution(6)).toBe(8);
  });
  it('should return 23 for number = 10', () => {
    expect(solution.solution(10)).toBe(23);
  });
});
