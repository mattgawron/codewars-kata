...
describe('tribonacci', () => {
  it('should work correctly for signature = [0, 0, 0] and n = 5', () => {
    expect(solution.tribonacci([0, 0, 0], 5)).toEqual([0, 0, 0, 0, 0]);
  });
  it('should work correctly for signature = [0, 0, 1] and n = 7', () => {
    expect(solution.tribonacci([0, 0, 1], 7)).toEqual([0, 0, 1, 1, 2, 4, 7]);
  });
  it('should work correctly for signature = [0, 1, 1] and n = 5', () => {
    expect(solution.tribonacci([0, 1, 1], 5)).toEqual([0, 1, 1, 2, 4]);
  });
  it('should work correctly for signature = [1, 0, 1] and n = 4', () => {
    expect(solution.tribonacci([1, 0, 1], 4)).toEqual([1, 0, 1, 2]);
  });
  it('should work correctly for signature = [1, 1, 1] and n = 3', () => {
    expect(solution.tribonacci([1, 1, 1], 3)).toEqual([1, 1, 1]);
  });
  it('should work correctly for signature = [1, 2, 3] and n = 5', () => {
    expect(solution.tribonacci([1, 2, 3], 5)).toEqual([1, 2, 3, 6, 11]);
  });
  it('should work correctly for signature = [2, 1, 3] and n = 2', () => {
    expect(solution.tribonacci([2, 1, 3], 2)).toEqual([2, 1]);
  });
});
